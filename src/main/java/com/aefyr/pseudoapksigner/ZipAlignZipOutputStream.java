...
public class ZipAlignZipOutputStream extends ZipOutputStream {
    ...
    public static ZipAlignZipOutputStream create(OutputStream outputStream, int alignment) {
        var bytesCounterOutputStream = new BytesCounterOutputStream(outputStream);
        var zipAlignZipOutputStream = new ZipAlignZipOutputStream(bytesCounterOutputStream, alignment);
    ...
    public void putNextEntry(ZipEntry zipEntry) throws IOException {
        if (zipEntry.getMethod() == ZipEntry.STORED) {
            ...
            var requiredPadding = (int) (mAlignment - ((mBytesCounter.getBytesWritten() + headerSize) % mAlignment));
